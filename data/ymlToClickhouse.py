...
class YMLtoClickhouse:
    def __init__(self, schema_name="im_8730_031"):
    ...
    def print_create_table(
        ...
        if order_by_column == "":
            order_by_column = columns[0]["name"]
            print(
                f"No ORDER BY column specified, defaulting to first column: {order_by_column}"
            )
