...
from data.generate_row import RowGenerator
...
@patch("data.generate_row.generate_incremental_field")
@patch("data.generate_row.generate_random_value")
@patch("data.generate_row.generate_random_email")
@patch("data.generate_row.generate_random_date")
@patch("data.generate_row.generate_iso8601_date")
@patch("data.generate_row.return_default_value")
@patch("data.generate_row.generate_random_number_from_range")
@patch("data.generate_row.generate_random_dictionary_value")
